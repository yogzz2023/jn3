...
def main():
    ...
    for group_idx, track_group in enumerate(tracks):
        ...
        for x, y, z, mt in track_group:
            ...
            updated_states.append((r, az, el, mt))  # Store updated state in spherical coordinates with measurement time

        perform_clustering_hypothesis_association(track_states, reports, cov_inv)

    # Print all updated states
    print("Updated States:")
    for r, az, el, mt in updated_states:
        print(f"Time: {mt}, State: r={r}, az={az}, el={el}")
