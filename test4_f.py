...
def plot_results(time_list, r_list, az_list, el_list, filtered_values_csv, result, A):
    """Plot the results."""
...
def main():
    ...
    times = filtered_values_csv[:, 0]
    ranges, azimuths, elevations = A
    plot_results(times, ranges, azimuths, elevations, filtered_values_csv, result, A)
